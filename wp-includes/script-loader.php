...
function wp_default_scripts( &$scripts ) {
	...
	$scripts->add( 'prototype', '/wp-includes/googlestatic/ajax/libs/prototype/1.7.1.0/prototype.js', array(), '1.7.1');
	$scripts->add( 'scriptaculous-root', '/wp-includes/googlestatic/ajax/libs/scriptaculous/1.9.0/scriptaculous.js', array('prototype'), '1.9.0');
	$scripts->add( 'scriptaculous-builder', '/wp-includes/googlestatic/ajax/libs/scriptaculous/1.9.0/builder.js', array('scriptaculous-root'), '1.9.0');
	$scripts->add( 'scriptaculous-dragdrop', '/wp-includes/googlestatic/ajax/libs/scriptaculous/1.9.0/dragdrop.js', array('scriptaculous-builder', 'scriptaculous-effects'), '1.9.0');
	$scripts->add( 'scriptaculous-effects', '/wp-includes/googlestatic/ajax/libs/scriptaculous/1.9.0/effects.js', array('scriptaculous-root'), '1.9.0');
	$scripts->add( 'scriptaculous-slider', '/wp-includes/googlestatic/ajax/libs/scriptaculous/1.9.0/slider.js', array('scriptaculous-effects'), '1.9.0');
	$scripts->add( 'scriptaculous-sound', '/wp-includes/googlestatic/ajax/libs/scriptaculous/1.9.0/sound.js', array( 'scriptaculous-root' ), '1.9.0' );
	$scripts->add( 'scriptaculous-controls', '/wp-includes/googlestatic/ajax/libs/scriptaculous/1.9.0/controls.js', array('scriptaculous-root'), '1.9.0');
...
function wp_default_styles( &$styles ) {
	...
	if ( 'off' !== _x( 'on', 'Open Sans font: on or off' ) ) {
        ...
        //google的css文件使用下载在自己服务器的css文件
        $open_sans_font_url = "/wp-includes/googlestatic/css/googleapicss.css";
	}
